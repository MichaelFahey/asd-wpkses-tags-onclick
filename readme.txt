=== ASD wpkses tags onclick ===
Contributors: michaelfahey
Tags: wp_kses, allowedtags, onClick
Requires PHP: 5.6
...
=== Description ===
This plugin configures WordPress sanitizing functions such as wp_kses to allow the onClick attribute for the div tag. It does not affect any other allowed/disallowed tags or attributes.
...
git clone https://github.com/MichaelFahey/asd-wpkses-tags-onclick.git
